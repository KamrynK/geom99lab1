...
This webpage is accessible on GitHub Pages web server using the URL `https://kamrynk.github.io/geom99lab1/clustering/ontarioparks.html` where `[username]` is replaced with your GitHub account username. 
